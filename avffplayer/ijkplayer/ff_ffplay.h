...
#define FF_PKT_TYPE_VIDEO 1
#define FF_PKT_TYPE_AUDIO 2
...
void (*fn_on_in_codec_parsed)(int, AVCodecContext*, int);
void (*fn_on_in_frame)(int, AVFrame*, AVCodecContext*, int);
